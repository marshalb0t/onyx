...
・[Support Server Invite](https://discord.gg/CaCTEJkfZA)
      ...
      .setColor("RANDOM")
          ...
          /*  const embeds = new Discord.MessageEmbed()
            ...
            .setDescription(`Run Command \`+help\` Followed By The Command If You Want To Get More Information About It !`)
            .addField(`Example:` , `\`\`\`+hel
            p ban\`\`\``); */
...
await msg.edit('',pages[page]).catch(error => console.error(error));
        ...
        const cmd = client.commands.get(name) || bot.commands.find(c => c.aliases && c.aliases.length && Array.isArray(c.aliases) && c.aliases.includes(name));
